...
namespace SmartFamily.Gedcom.Tests.EncoderTests
{
    /// <summary>
    /// Rigorous tests to ensure that ANSI files can be properly loaded and converted to Unicode.
    /// </summary>
    public class GedcomAnsiEncoderTest
    {
        /// <summary>
        /// Checks that the ANSI encoding is recognized.
        /// </summary>
        [Fact]
